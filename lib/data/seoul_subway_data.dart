...
class SeoulSubwayData {
  ...
  static const List<StationInfo> line1Stations = [
    ...
    StationInfo(id: '1001-123', name: '회기', lat: 37.5895, lng: 127.0585, transferLines: ['1063', '1067'], dwellSec: 30, travelNextSec: 150),
    StationInfo(id: '1001-124', name: '청량리', lat: 37.5804, lng: 127.0467, transferLines: ['1063', '1067', '1075'], dwellSec: 30, travelNextSec: 90),
    // ── 서울교통공사 1호선 (청량리 → 서울역) ──
    ...
    StationInfo(id: '1001-133', name: '서울역', lat: 37.5547, lng: 126.9723, transferLines: ['1004', '1063', '1065', '1032'], dwellSec: 30, travelNextSec: 120),
    // ── 경부선 (서울역 → 구로 → 신창) ──
  ...
  static const List<StationInfo> line4Stations = [
    ...
    StationInfo(id: '1004-417', name: '서울역', lat: 37.5547, lng: 126.9723, transferLines: ['1001', '1063', '1065', '1032']),
  ...
  static const List<StationInfo> line1063Stations = [
    ...
    StationInfo(id: '1063-016', name: '화전', lat: 37.6013, lng: 126.8639),
    ...
    StationInfo(id: '1063-024', name: '서울역', lat: 37.5547, lng: 126.9723, transferLines: ['1001', '1004', '1065', '1032']),
    StationInfo(id: '1063-025', name: '용산', lat: 37.529849, lng: 126.964561, transferLines: ['1001']),
    StationInfo(id: '1063-026', name: '이촌', lat: 37.522295, lng: 126.974733, transferLines: ['1004']),
    StationInfo(id: '1063-027', name: '서빙고', lat: 37.519594, lng: 126.988537),
    StationInfo(id: '1063-028', name: '한남', lat: 37.52943, lng: 127.009169),
    StationInfo(id: '1063-029', name: '옥수', lat: 37.5437, lng: 127.0160, transferLines: ['1003']),
    StationInfo(id: '1063-030', name: '응봉', lat: 37.549946, lng: 127.034538),
    StationInfo(id: '1063-031', name: '왕십리', lat: 37.561238, lng: 127.036954, transferLines: ['1002', '1005', '1075']),
    StationInfo(id: '1063-032', name: '청량리', lat: 37.5824, lng: 127.0439, transferLines: ['1001', '1075', '1067']),
    StationInfo(id: '1063-033', name: '회기', lat: 37.58946, lng: 127.057583, transferLines: ['1001', '1067']),
    StationInfo(id: '1063-034', name: '중랑', lat: 37.594917, lng: 127.076116, transferLines: ['1067']),
    StationInfo(id: '1063-035', name: '상봉', lat: 37.5985, lng: 127.0836, transferLines: ['1007', '1067']),
    StationInfo(id: '1063-036', name: '망우', lat: 37.59955, lng: 127.091909, transferLines: ['1067']),
    StationInfo(id: '1063-037', name: '양원', lat: 37.606596, lng: 127.107906),
    StationInfo(id: '1063-038', name: '구리', lat: 37.603392, lng: 127.143869),
    StationInfo(id: '1063-039', name: '도농', lat: 37.608806, lng: 127.161153),
    StationInfo(id: '1063-040', name: '양정', lat: 37.6067, lng: 127.1925),
    StationInfo(id: '1063-041', name: '덕소', lat: 37.586781, lng: 127.208832),
    StationInfo(id: '1063-042', name: '도심', lat: 37.579622, lng: 127.222672),
    StationInfo(id: '1063-043', name: '팔당', lat: 37.547371, lng: 127.243939),
    StationInfo(id: '1063-044', name: '운길산', lat: 37.554669, lng: 127.310115),
    StationInfo(id: '1063-045', name: '양수', lat: 37.545981, lng: 127.329098),
    StationInfo(id: '1063-046', name: '신원', lat: 37.525545, lng: 127.372921),
    StationInfo(id: '1063-047', name: '국수', lat: 37.516169, lng: 127.399367),
    StationInfo(id: '1063-048', name: '아신', lat: 37.51382, lng: 127.443173),
    StationInfo(id: '1063-049', name: '오빈', lat: 37.506062, lng: 127.473868),
    StationInfo(id: '1063-050', name: '양평', lat: 37.492773, lng: 127.491837),
    StationInfo(id: '1063-051', name: '원덕', lat: 37.468672, lng: 127.547076),
    StationInfo(id: '1063-052', name: '용문', lat: 37.48223, lng: 127.594647),
    StationInfo(id: '1063-053', name: '지평', lat: 37.476393, lng: 127.629874),
  ];
